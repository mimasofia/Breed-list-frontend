...
var breedEvents = __webpack_require__(16);
...
var onSignOut = function onSignOut(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signOut(data).then(ui.signOutSuccess).catch(ui.signOotFailure);
};
...
var breedApi = __webpack_require__(17);
var breedUi = __webpack_require__(18);

var onCreateNewListItem = function onCreateNewListItem(event) {
  var data = getFormFields(this);
  event.preventDefault();
  breedApi.createNewListItem(data).then(breedUi.createNewListItemSuccess).catch(breedUi.createNewListItemFailure);
  $('#create-new-list-item').find('input:text, input:password, select, textarea').val('');
  $('input[type=number]').val('');
};

var onShowFullList = function onShowFullList(event) {
  var data = getFormFields(this);
  event.preventDefault();
  breedApi.showFullList(data).then(breedUi.showFullListSuccess).catch(breedUi.showFullListFailure);
};

var onClearList = function onClearList(event) {
  event.preventDefault();
  breedUi.clearList();
};

var onShowOneBreed = function onShowOneBreed(event) {
  var data = getFormFields(this);
  event.preventDefault();
  breedApi.showOneBreed(data).then(breedUi.showOneBreedSuccess).catch(breedUi.showOneBreedFailure);
...
var onUpdateListItem = function onUpdateListItem(event) {
  var data = getFormFields(this);
  event.preventDefault();
  breedApi.updateListItem(data).then(breedUi.updateListItemSuccess).catch(breedUi.updateListItemFailure);
  $('#update-list-item').find('input:text, input:password, select, textarea').val('');
  $('input[type=number]').val('');
};

var onRemoveOneListItem = function onRemoveOneListItem(event) {
  var data = getFormFields(this);
  event.preventDefault();
  breedApi.removeOneListItem(data).then(breedUi.removeOneListItemSuccess).catch(breedUi.removeOneListItemFailure);
...
var createNewListItem = function createNewListItem(data) {
  return $.ajax({
...
var showFullList = function showFullList(data) {
  return $.ajax({
    url: config.apiOrigin + '/breed_lists/',
    method: 'GET',
    headers: {
...
var showOneBreed = function showOneBreed(data) {
  return $.ajax({
...
var updateListItem = function updateListItem(data) {
  return $.ajax({
    url: config.apiOrigin + '/breed_lists/' + data.breed_list.id,
    method: 'PATCH',
    headers: {
...
var removeOneListItem = function removeOneListItem(data) {
  return $.ajax({
    url: config.apiOrigin + '/breed_lists/' + data.breed_list.id,
    method: 'DELETE',
    headers: {
...
module.exports = {
  ...
  showOneBreed: showOneBreed,
  updateListItem: updateListItem,
  removeOneListItem: removeOneListItem
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showBreedList = __webpack_require__(19);

var createNewListItemSuccess = function createNewListItemSuccess(data) {
  // console.log(data)
  // console.log('success')
...
var createNewListItemFailure = function createNewListItemFailure() {
  // console.log(error)
  // console.log('nope')
  $('.add-dog-messages').text('Please input all fields to add to list');
  $('.messages').text('Please input all fields to add to list');
};
var showFullListSuccess = function showFullListSuccess(data) {
  $('.list').empty();
  $('.details').hide();
  $('.messages').text('');
  $('.modal-messages').text('');
  if (data.breed_lists.length === 0) {
    ...
    var showBreedHtml = showBreedList({ breed_lists: data.breed_lists });
...
var showFullListFailure = function showFullListFailure() {
  $('.messages').text('Error try again');
  $('.details').hide();
};

var showOneBreedSuccess = function showOneBreedSuccess(data) {
  // console.log(error)
...
var showOneBreedFailure = function showOneBreedFailure(data) {
  // console.log(error)
...
var updateListItemSuccess = function updateListItemSuccess(data) {
  $('.list').empty();
  var breedHtml = '\n    <h3>Breed: ' + data.breed_list.breed + '</h3>\n    <p>Dog ID: ' + data.breed_list.id + '</p>\n    <p>Gender: ' + data.breed_list.gender + '</p>\n    <p>Weight: ' + data.breed_list.weight + '</p>\n    <p>Height: ' + data.breed_list.height + '</p>\n    ';
  $('.list').append(breedHtml);
...
var removeOneListItemSuccess = function removeOneListItemSuccess(data) {
  $('.list').empty();
...
var removeOneListItemFailure = function removeOneListItemFailure() {
...
module.exports = {
  createNewListItemSuccess: createNewListItemSuccess,
  createNewListItemFailure: createNewListItemFailure,
  showFullListSuccess: showFullListSuccess,
  showFullListFailure: showFullListFailure,
  showOneBreedSuccess: showOneBreedSuccess,
  showOneBreedFailure: showOneBreedFailure,
  updateListItemSuccess: updateListItemSuccess,
  updateListItemFailure: updateListItemFailure,
  removeOneListItemSuccess: removeOneListItemSuccess,
  removeOneListItemFailure: removeOneListItemFailure,
  clearList: clearList
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!-- each is an interation method for handelbars-->\n\n <!-- Developers, why are we using data-id and not just id? -->\n <p>\n  <p><h1 data-id=\""
    ...
    + "</p>\n  <p>Height: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.height : stack1), depth0))
    + "</p>\n  <!-- data attribute in hrml we dont use id  there becuase you dont want to assume you wont get\nduplicates not a big deal if teo things have the same data-id -->\n<!-- <small><li><button data-id=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.breed_lists : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"removeDogItem\" class=\"btn btn-default\">Remove item from list</button></li></small> -->\n</p>\n  <!-- if the book has an author it will show that and if it doesn;t it will\nsay whats in the else, truthy things -->\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.breed_lists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
